...
class Login extends JFrame implements ActionListener
{
	...
	Login()
	{
		...
		l3 = new JLabel(new ImageIcon("D:\\med\\medical\\src\\images\\users.png"));
        ...
        l4 = new JLabel(new ImageIcon("D:\\med\\medical\\src\\images\\pass.png"));
		...
		b1 = new JButton("Login",new ImageIcon("D:\\med\\medical\\src\\images\\Login.png"));
		b1.setBounds(200,400,100,35);
		jf.add(b1);b1.addActionListener(this);

		b2 = new JButton("Clear",new ImageIcon("D:\\med\\medical\\src\\images\\clear.png"));
		b2.setBounds(320,400,100,35);
		jf.add(b2);b2.addActionListener(this);

		b3 = new JButton("Exit",new ImageIcon("D:\\med\\medical\\src\\images\\exit.png"));
