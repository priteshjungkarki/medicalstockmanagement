...
class Login extends JFrame implements ActionListener
{
    ...
    Color c=new Color(191,239,255);
    Color cc=new Color(47,79,79);
	JFrame jf;
	JButton b1,b2,b3;
	...
	Login()
	{
		...
		l3 = new JLabel(new ImageIcon("G:\\project ducat\\medical stock management system\\medical\\src\\images\\users.png"));
        ...
        l4 = new JLabel(new ImageIcon("G:\\project ducat\\medical stock management system\\medical\\src\\images\\pass.png"));
		...
		b1 = new JButton("Login",new ImageIcon("G:\\project ducat\\medical stock management system\\medical\\src\\images\\Login.png"));
		b1.setBounds(200,400,100,35);
		jf.add(b1);
		b1.addActionListener(this);

		b2 = new JButton("Clear",new ImageIcon("G:\\\\project ducat\\\\medical stock management system\\medical\\src\\images\\clear.png"));
		b2.setBounds(320,400,100,35);
		jf.add(b2);
		b2.addActionListener(this);

		b3 = new JButton("Exit",new ImageIcon("G:\\\\project ducat\\\\medical stock management system\\medical\\src\\images\\exit.png"));
